...
north.onAdd = function(map) {
  ...
  var northImageUrl = "{% static 'assets/images/North.png' %}";
...
map.on("contextmenu", (e) => {
  ...
  // let layer = 'postgres:'+ checkedValues;
  // let style = 'postgres:'+ checkedValues;
// http://localhost:8080/geoserver/zone/wms
      ...
      fetch(urrr)
          ...
          .then((html) => {
              ...
              //     "</td></tr></table></div>`
                  ...
                  <a href="/before_payment">Upload File </a>
                  
                  </td>

                  <td>
                 
                  <input type="button" id='btnExport' class=btn-success value="Download"/>
